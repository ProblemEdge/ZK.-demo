...
export default function Slide2() {
  return (
    <section className='w-full h-[60vh] md:h-[70vh] flex flex-col items-center gap-8 px-4 text-center whitespace-nowrap'>
      {/* タイトル */}
        ...
        <div className='self-end w-full md:w-2/3 flex justify-end '>
          <div className='flex flex-col items-end translate-x-8 translate-y-3 gap-1'>
            ...
            <div className='flex items-stretch gap-4'>
              ...
              <div className='w-[12px] min-w-[12px] self-stretch bg-[#FF1744]' aria-hidden='true' />
            </div>
          ...
          <div className='flex flex-col items-start translate-y-3 -translate-x-8 gap-1'>
            ...
            <div className='flex items-stretch gap-4'>
              ...
              <h3 className='text-4xl md:text-3xl font-bold text-left leading-tight'>
                ...
                <span className='text-[#00e676]'>投</span>
                <span className='text-[#ff1744]'>票</span>しよう
              </h3>
            </div>
